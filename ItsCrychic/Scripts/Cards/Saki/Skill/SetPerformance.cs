...
public class SetPerformance() : AbstractSakikoCard(CustomCost, CustomType, CustomRarity, CustomTarget)
{
    ...
    [
        new PowerVar<SetPerformancePower>(1)
    ];

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        await PowerCmd.Apply<SetPerformancePower>(choiceContext, Owner.Creature,
            DynamicVars["SetPerformancePower"].IntValue, Owner.Creature, this);
    }
